...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>Option</th><th>Departement</th><th>OptionAraB</th><th>CodeOption</th><th colspan='2'>Operation</th></tr>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<input type='hidden' name='Departement' value='" . htmlspecialchars($row['Departement']) . "'>";
            echo "<button type='submit' name='supp' class='supp'>Delete</button>";
            echo "</form>";
            echo "</td>";
            echo "<td>";
            echo "<a href='update.php?Option=" . $row['Option'] . "&Departement=" . $row['Departement'] . "'>";
